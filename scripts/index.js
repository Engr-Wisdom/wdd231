...
let courseCont = document.getElementById("courses");
let allBtn = document.getElementById("all-btn");
let cseBtn = document.getElementById("cse-btn");
let wddBtn = document.getElementById("wdd-btn");
...
function displayCourse(courses) {
    ...
    let count = courses.reduce((acc, course) => acc + course.credits, 0);
    ...
    courses.forEach(course => {
        ...
        if ((course.subject === "CSE" && course.number === 110) || (course.subject === "WDD" && course.number === 130) || (course.subject === "CSE" && course.number === 111)) {
            course.completed = true;
            p.className = "taken";
        }
        courseCont.appendChild(p);
    });
}
